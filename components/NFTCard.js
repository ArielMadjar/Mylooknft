...
const style = {
  wrapper: `border-2 border-indigo-500/75 bg-[#303339] flex-auto w-[14rem] h-45rem] my-10 mx-5 rounded-2xl overflow-hidden cursor-pointer`,
